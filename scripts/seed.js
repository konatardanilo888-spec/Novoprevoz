...
function seedNotifications() {
  ...
  const demoNotifications = [
    { title: 'Promjena voznog reda', content: 'Od 1. oktobra 2026. na snazi je novi ljetnji vozni red za relaciju Podgorica - Budva.', type: 'INFO' },
    { title: 'Privremena izmjena polazaka', content: 'Zbog radova na putu, polasci ka Kotoru u periodu 20-25.9 kasne do 15 minuta.', type: 'UPOZORENJE' },
    { title: 'Važno obavještenje za putnike', content: 'Molimo putnike da na autobusku stanicu dođu najmanje 15 minuta prije polaska radi preuzimanja karata.', type: 'VAZNO' },
  ];
