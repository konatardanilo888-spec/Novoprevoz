...
const notificationSchema = {
    ...
    title_en: [isString({ max: 150 })],
    content_en: [isString({ max: 1000 })],
...
function create(req, res) {
    ...
    const notification = notificationModel.create({
          ...
          title_en: req.body.title_en ? String(req.body.title_en).trim() : null,
          content_en: req.body.content_en ? String(req.body.content_en).trim() : null,
